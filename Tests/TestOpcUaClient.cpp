...
namespace Umati {
	namespace OpcUa {
		...
		public:
			TestOpcUaClient(std::string serverURI, std::string Username = std::string(),
...
TEST(OpcUaClient, TranslateBrowsePathToNodeId) {
	...
	Umati::OpcUa::TestOpcUaClient client(std::string("someUrl"), std::string("someUser"), std::string("somePassword"),
										 OpcUa_MessageSecurityMode_None, mockWrapper);
