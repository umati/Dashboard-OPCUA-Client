...
NodeDefinition::NodeDefinition(const NodeDefinition nd, QualifiedName_t specifiedBrowseName)
  : NodeClass(nd.NodeClass),
    ModellingRule(nd.ModellingRule),
    ReferenceType(nd.ReferenceType),
    SpecifiedTypeNodeId(nd.SpecifiedTypeNodeId),
...
StructureNode::StructureNode(
  ...
  : NodeDefinition(nodeClass, modellingRule, std::move(referenceType), std::move(specifiedTypeNodeId), std::move(specifiedBrowseName)),
    SpecifiedChildNodes(std::move(std::move(childNodes))) {
  this->ofBaseDataVariableType = ofBaseDataVariableType;
}

StructureNode::StructureNode(const StructureNode *structureNode, const QualifiedName_t SpecifiedBrowseName)
  : SpecifiedChildNodes(structureNode->SpecifiedChildNodes),
    ofBaseDataVariableType(structureNode->ofBaseDataVariableType),
    NodeDefinition(*dynamic_cast<const NodeDefinition *>(structureNode), SpecifiedBrowseName) {}

StructureNode::StructureNode(
  const ModelOpcUa::BrowseResult_t &browseResult, bool ofBaseDataVariableType, std::shared_ptr<std::list<std::shared_ptr<StructureNode>>> childNodes)
  : SpecifiedChildNodes(std::move(std::move(childNodes))),
    NodeDefinition(browseResult.NodeClass, Optional, browseResult.ReferenceTypeId, browseResult.TypeDefinition, browseResult.BrowseName) {
  this->ofBaseDataVariableType = ofBaseDataVariableType;
}
...
StructureNode::StructureNode(
  ...
  bool ofBaseDataVariableType)
  : SpecifiedChildNodes(std::move(std::move(childNodes))),
    NodeDefinition(browseResult.NodeClass, modellingRule, browseResult.ReferenceTypeId, browseResult.TypeDefinition, browseResult.BrowseName) {
  this->ofBaseDataVariableType = ofBaseDataVariableType;
}
...
void StructureNode::printYamlIntern(const std::shared_ptr<StructureNode> &node, const std::string &parentTree, int tabs, std::ostream &ss) {
  std::stringstream ss_self;
...
StructureNode::StructureNode(StructureNode *structureNode, bool ofBaseDataVariableType, std::shared_ptr<std::list<std::shared_ptr<StructureNode>>> childNodes)
  : NodeDefinition(
...
StructurePlaceholderNode::StructurePlaceholderNode(
  ...
  assert(modellingRule == ModellingRule_t::MandatoryPlaceholder || modellingRule == ModellingRule_t::OptionalPlaceholder);
}

StructurePlaceholderNode::StructurePlaceholderNode(const std::shared_ptr<StructureNode> &sharedPtr)
  : StructureNode(
      sharedPtr->NodeClass,
      sharedPtr->ModellingRule,
      sharedPtr->ReferenceType,
      sharedPtr->SpecifiedTypeNodeId,
      sharedPtr->SpecifiedBrowseName,
      sharedPtr->ofBaseDataVariableType,
      sharedPtr->SpecifiedChildNodes) {}

StructureBiNode::StructureBiNode(
  BrowseResult_t browseResult,
  bool ofBaseDataVariableType,
  std::shared_ptr<std::list<std::shared_ptr<StructureNode>>> childNodes,
  std::shared_ptr<StructureBiNode> parent,
  std::string namespaceUri)
  : structureNode(std::make_shared<StructureNode>(browseResult, false, childNodes)), parent(std::move(std::move(parent))), namespaceUri(namespaceUri) {}
...
StructureBiNode::StructureBiNode(
  ...
  std::string namespaceUri)
  : structureNode(
      std::make_shared<StructureNode>(nodeClass, modellingRule, referenceType, specifiedTypeNodeId, specifiedBrowseName, ofBaseDataVariableType, childNodes)),
    parent(std::move(std::move(parent))),
    namespaceUri(namespaceUri) {}
