 ...
 * binary encoding, ...). */
#define UA_TYPES_MACHINERY_RESULT_COUNT 6
extern UA_EXPORT UA_DataType UA_TYPES_MACHINERY_RESULT[UA_TYPES_MACHINERY_RESULT_COUNT];

/* BaseResultTransferOptionsDataType: Abstract type containing information which file should be provided. */
typedef struct {
  UA_String resultId;
} UA_BaseResultTransferOptionsDataType;

#define UA_TYPES_MACHINERY_RESULT_BASERESULTTRANSFEROPTIONSDATATYPE 0

/* ResultTransferOptionsDataType: Contains information which file should be provided. */
typedef struct {
  UA_String resultId;
...
/* ProcessingTimesDataType: Contains measured times that were generated during the execution of a recipe. */
typedef struct {
...
#define UA_TYPES_MACHINERY_RESULT_PROCESSINGTIMESDATATYPE 2

/* ResultDataType: Contains fields that were created during the execution of a recipe. */
typedef struct {
  UA_ExtensionObject resultMetaData;
  size_t resultContentSize;
  UA_Variant *resultContent;
} UA_ResultDataType;

#define UA_TYPES_MACHINERY_RESULT_RESULTDATATYPE 3

/* ResultEvaluationEnum: Indicates whether a result was in tolerance */
typedef enum {
...
#define UA_TYPES_MACHINERY_RESULT_RESULTEVALUATIONENUM 4

/* ResultMetaDataType: Meta data of a result, describing the result. */
typedef struct {
  UA_String resultId;
...
#define UA_TYPES_MACHINERY_RESULT_RESULTMETADATATYPE 5
