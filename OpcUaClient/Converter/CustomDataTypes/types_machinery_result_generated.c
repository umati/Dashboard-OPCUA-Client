...
static UA_DataTypeMember BaseResultTransferOptionsDataType_members[1] = {
  {
...
static UA_DataTypeMember ResultDataType_members[2] = {
  ...
  },
  {
    ...
    offsetof(UA_ResultDataType, resultContentSize) - offsetof(UA_ResultDataType, resultMetaData) - sizeof(UA_ExtensionObject), /* .padding */
    true,                                                                                                                      /* .isArray */
    false                                                                                                                      /* .isOptional */
  },
};
...
UA_DataType UA_TYPES_MACHINERY_RESULT[UA_TYPES_MACHINERY_RESULT_COUNT] = {
  /* BaseResultTransferOptionsDataType */
  {
    UA_TYPENAME("BaseResultTransferOptionsDataType") /* .typeName */
    {0, UA_NODEIDTYPE_NUMERIC, {3005LU}},            /* .typeId */
    {0, UA_NODEIDTYPE_NUMERIC, {0}},                 /* .binaryEncodingId */
    sizeof(UA_BaseResultTransferOptionsDataType),    /* .memSize */
    UA_DATATYPEKIND_STRUCTURE,                       /* .typeKind */
    false,                                           /* .pointerFree */
    false,                                           /* .overlayable */
    1,                                               /* .membersSize */
    BaseResultTransferOptionsDataType_members        /* .members */
  },
  /* ResultTransferOptionsDataType */
  {
  ...
  /* ResultDataType */
  {
    ...
    {0, UA_NODEIDTYPE_NUMERIC, {5008LU}}, /* .binaryEncodingId */
  ...
  /* ResultMetaDataType */
  {
    ...
    {0, UA_NODEIDTYPE_NUMERIC, {5005LU}}, /* .binaryEncodingId */
