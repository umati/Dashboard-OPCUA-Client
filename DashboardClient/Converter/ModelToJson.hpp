	...
	namespace Dashboard
	{
		namespace Converter
		{
			...
			public:
                ...
                * - placeholderElements
                */
				ModelToJson(const std::shared_ptr<const ModelOpcUa::Node>& pNode, const getValue_t& getValue,  bool serializeNodeInformation = false, bool nestAsChildren = false, bool publishNullValues = false);
